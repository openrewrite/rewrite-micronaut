...
recipeDependencies {
    ...
    parserClasspath("io.micronaut:micronaut-context:4.0.0-M6")
    parserClasspath("io.micronaut:micronaut-websocket:4.0.0-M6")
    parserClasspath("io.micronaut.validation:micronaut-validation:4.0.0-M9")
    parserClasspath("io.micronaut:micronaut-retry:4.0.0-M6")
    parserClasspath("io.micronaut.email:micronaut-email:2.0.0-M3")
