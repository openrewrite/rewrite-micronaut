...
recipeDependencies {
    ...
    parserClasspath("io.micronaut:micronaut-context:4.0.0-RC5")
    parserClasspath("io.micronaut:micronaut-websocket:4.0.0-RC5")
    parserClasspath("io.micronaut.validation:micronaut-validation:4.0.0-M12")
    parserClasspath("io.micronaut:micronaut-retry:4.0.0-RC5")
    parserClasspath("io.micronaut.email:micronaut-email:2.0.0-M6")
    parserClasspath("io.micronaut.data:micronaut-data-jdbc:3.9.1")
    parserClasspath("io.micronaut.data:micronaut-data-jdbc:4.0.0-M15")
    parserClasspath("io.micronaut.data:micronaut-data-model:4.0.0-M15")
    parserClasspath("io.micronaut.data:micronaut-data-tx:3.9.1")
    parserClasspath("io.micronaut.data:micronaut-data-tx:4.0.0-M15")
    ...
    parserClasspath("javax.transaction:javax.transaction-api:1.3")
    parserClasspath("jakarta.transaction:jakarta.transaction-api:2.0.1")
}
